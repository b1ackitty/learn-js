...
// 체크박스 요소의 브라우저 기본 작동 방지 -> HTML에서 disabled 속성을 줘도 됨
// change 이벤트
;(() => {
...
;(() => {
  ...
  form.addEventListener('submit', (e) => {
    ...
    // JavaScript를 사용해 사용자 입력 값 검토 처리
    const formElement = e.currentTarget
    console.log(formElement) // <form>
    // console.log(formElement.elements) // HTMLFormControlsCollection
    // console.log(formElement.elements.searchTerm) // <input>
    console.log(formElement.elements.searchTerm.value) // <input>의 value 값
  })
  ...
  form.addEventListener('reset', (e) => {
    ...
    // 매뉴얼 리셋(Manual Reset)
    e.currentTarget.elements['searchTerm'].value = ''
  })
})()