...
;(() => {
  // 조건문
  {
    ...
    if (user.age >= 19) {
      ...
      warningMessage = '19세 이상이므로 출입이 불가합니다. ⚠️'
    }
...
// 실습 1
;(() => {
  // 나이에 따라 책정된 입장료를 반환하는 함수 코드를 조건식을 사용해 작성하세요.
  ...
  const entranceFeesStatement = [
    getEntranceFeeByAgeStatement(21),
    getEntranceFeeByAgeStatement(10),
    getEntranceFeeByAgeStatement(73)
  ]

  console.log(entranceFeesStatement) // [5000, 2000, 3000]
})

// 실습 2
;(() => {
  // 점수에 따라 등급을 판별해 반환하는 함수 코드를 조건문을 사용해 작성하세요.
