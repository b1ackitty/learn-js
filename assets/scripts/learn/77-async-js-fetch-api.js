...
;(() => {
  ...
  // OPTIONS
  // fetch 옵션(서버에 보낼 요청의 선택 사항)
  // const response = fetchfetch('https://api.github.com/users/yamoo9', {
  //   method: '요청 방법',
  ...
  //  3. 필요한 경우 fetch() 함수의 두 번째 매개변수로 options를 전달받는다.
  //  4. fetch() 함수의 옵션 객체는 요청 방법(method), 요청 헤더(headers), 요청 본문(body) 등으로 구성된다.
  //  5. fetch() 함수의 반환 값은 Promise 객체다.
