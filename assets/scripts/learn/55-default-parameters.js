...
;(() => {
  const calculateTaxes = (income, taxRate = 0.033) => income * taxRate
...
;(() => {
  ...
  // 함수에 전달할 인수의 순서를 정확히 기억해야 한다!
  // let lee = createUser('이현준', 21, '대학생', '서울', 'leehj@edu.io', '********')
...
;(() => {
  ...
  function handleClick1(e) {
    ...
    // 함수 내부에서 구조 분해 할당해서 사용하면 e도 사용할 수 있다.
  ...
  function handleClick2({ currentTarget: aElement, type }) {
    ...
    // e.preventDefault()
    // preventDefault() // Uncaught TypeError: Illegal inovation
